...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241211233518_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 12, 11, 18, 35, 18, 193, DateTimeKind.Local).AddTicks(7273),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 12, 11, 18, 35, 18, 193, DateTimeKind.Local).AddTicks(7286),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 12, 11, 18, 35, 18, 193, DateTimeKind.Local).AddTicks(7287),
                            ServicesID = 5
                        });
                });
